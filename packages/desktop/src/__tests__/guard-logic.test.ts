...
import {
  toGuardReportDataFromRecord,
  buildGuardLevels,
  deriveGuardStatus,
} from '../pages/guard-logic';
    ...
    const levels = buildGuardLevels([
      {
        ...
        ok: false,
        riskLevel: 'high',
        summary: { total: 3, passed: 1, failed: 2, warnings: 0, blocking: 2, errors: 0 },
        checks: [],
      },
      {
        ...
        ok: true,
        riskLevel: 'low',
        summary: { total: 2, passed: 2, failed: 0, warnings: 0, blocking: 0, errors: 0 },
        checks: [],
      },
      {
        timestamp: '2026-08-07T10:00:00.000Z',
        triggerSource: 'pre-push',
        ok: false,
        riskLevel: 'medium',
        summary: { total: 4, passed: 3, failed: 0, warnings: 1, blocking: 1, errors: 0 },
        checks: [],
      },
      {
    ...
    const levels = buildGuardLevels([
      {
        ...
        ok: true,
        riskLevel: 'low',
        summary: { total: 1, passed: 1, failed: 0, warnings: 0, blocking: 1, errors: 0 },
        checks: [],
      },
      {
        timestamp: '2026-08-07T09:00:00.000Z',
        ...
        ok: true,
        riskLevel: 'low',
        summary: { total: 1, passed: 1, failed: 0, warnings: 1, blocking: 0, errors: 1 },
        checks: [],
      },
    ]);
