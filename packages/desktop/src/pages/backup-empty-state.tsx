...
export function CloudUpload() {
  return (
    <svg width="150" height="150" viewBox="0 0 150 150" fill="none">
      ...
      {/* 云朵 */}
      <path
        d="M48 82c-8 0-14-6-14-14s6-14 14-14c2-10 12-17 22-15 4-9 14-14 23-11 9-4 20-1 24 8 5 2 8 7 8 12s-3 10-8 13l-69 21z"
        fill="rgb(var(--zh-brand) / 0.08)"
