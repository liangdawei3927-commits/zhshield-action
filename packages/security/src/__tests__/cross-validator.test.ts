...
describe('GrypeCrossValidator', () => {
  ...
  it('should detect high-confidence matches (A intersect B)', () => {
    const trivy = [
      makeIssue({ ruleId: 'CVE-2024-1234', message: 'lodash@4.17.20: ReDoS', fingerprint: 'trivy:CVE-2024-1234:lodash' }),
    ];
    const grype = [
      makeIssue({ ruleId: 'CVE-2024-1234', message: 'lodash@4.17.20: ReDoS', fingerprint: 'grype:CVE-2024-1234:lodash' }),
    ];
  ...
  it('should detect trivy-only findings', () => {
    const trivy = [
      makeIssue({ ruleId: 'CVE-2024-5678', message: 'express@4.18.0: XSS', fingerprint: 'trivy:CVE-2024-5678:express' }),
    ];
    const grype: Issue[] = [];
  ...
  it('should detect grype-only findings', () => {
    const trivy: Issue[] = [];
    const grype = [
      makeIssue({ ruleId: 'CVE-2024-9999', message: 'axios@1.6.0: SSRF', fingerprint: 'grype:CVE-2024-9999:axios' }),
    ];
  ...
  it('should handle mixed results', () => {
    const trivy = [
      makeIssue({ ruleId: 'CVE-2024-1111', message: 'pkg-a@1.0: vuln', fingerprint: 'trivy:CVE-2024-1111:pkg-a' }),
      makeIssue({ ruleId: 'CVE-2024-2222', message: 'pkg-b@2.0: vuln', fingerprint: 'trivy:CVE-2024-2222:pkg-b' }),
    ];
    const grype = [
      makeIssue({ ruleId: 'CVE-2024-1111', message: 'pkg-a@1.0: vuln', fingerprint: 'grype:CVE-2024-1111:pkg-a' }),
      makeIssue({ ruleId: 'CVE-2024-3333', message: 'pkg-c@3.0: vuln', fingerprint: 'grype:CVE-2024-3333:pkg-c' }),
    ];
  ...
  it('should skip non-security issues', () => {
    const trivy = [
      makeIssue({ ruleId: 'CVE-2024-1234', message: 'vuln', category: 'dependency', fingerprint: 'trivy:CVE-2024-1234:pkg' }),
    ];
    const grype = [
      makeIssue({ ruleId: 'CVE-2024-1234', message: 'vuln', category: 'security', fingerprint: 'grype:CVE-2024-1234:pkg' }),
    ];
  ...
  it('should degrade severity for pending_confirmation findings', () => {
    const trivy = [
      makeIssue({ ruleId: 'CVE-2024-5555', severity: 'error', message: 'pkg@1.0: critical vuln', fingerprint: 'trivy:CVE-2024-5555:pkg' }),
    ];
    const grype: Issue[] = [];
  ...
  it('should use max severity for high-confidence findings', () => {
    const trivy = [
      makeIssue({ ruleId: 'CVE-2024-7777', severity: 'error', message: 'pkg@1.0: vuln', fingerprint: 'trivy:CVE-2024-7777:pkg' }),
    ];
    const grype = [
      makeIssue({ ruleId: 'CVE-2024-7777', severity: 'warning', message: 'pkg@1.0: vuln', fingerprint: 'grype:CVE-2024-7777:pkg' }),
    ];
