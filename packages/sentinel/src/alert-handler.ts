...
export class AlertHandler {
  ...
  handleWebhook(token: string, payload: AlertPayload): { accepted: boolean; eventId?: string; reason?: string } {
  ...
  private validateRequest(token: string, payload: AlertPayload): { accepted: boolean; reason?: string } {
